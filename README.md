...
- В `README.md` описаны запуск и проверка проекта
- Для pet-project — релиз на `GitHub Releases` по подписанному тегу
...
и ставит слово в нужную форму («36 материалов», «44 схемы»); неизвестный токен `{{ stats.* }}` даёт warning,
