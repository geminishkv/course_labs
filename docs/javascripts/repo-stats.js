document.addEventListener("DOMContentLoaded", function () {
  ...
  function render(stars, forks, release) {
    var sources = document.querySelectorAll(".md-source__repository");
  ...
  if (cached && Date.now() - cached.ts < cacheTTL) {
    render(cached.stars, cached.forks, cached.release);
    return;
  }
