...
<div class="lab-hero">
  <div class="lab-hero-num">D1</div>
  <div class="lab-hero-content">
    <h1 class="lab-hero-title">Рантайм: hardening и сегментация</h1>
    <div class="lab-hero-tags">
      <span class="lab-tag">Docker</span>
      <span class="lab-tag">Hardening</span>
      <span class="lab-tag">Compose</span>
    </div>
  </div>
</div>
