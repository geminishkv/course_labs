---
title: "Углублённый трек Docker: рантайм и поставка | Курс AppSec"
description: "Две углублённые лабораторные курса AppSec по Docker: безопасный запуск контейнера и цепочка поставки образа, с разбором ложных срабатываний."
