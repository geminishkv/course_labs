...
<div class="lab-hero">
  ...
  <div class="lab-hero-content">
    <h1 class="lab-hero-title">Docker CIS Benchmark — аудит Docker-хоста</h1>
...
- [Docker Cheatsheet](../artifacts/cheatsheet/CHEATSHEET_DOCKER.md) — справочник по командам Docker
