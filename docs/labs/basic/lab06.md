---
title: "Лаб. 06 — Docker CIS Benchmark и Trivy | Курс AppSec"
...
<div class="lab-hero">
  ...
  <div class="lab-hero-content">
    <h1 class="lab-hero-title">Docker CIS Benchmark и Trivy</h1>
    <div class="lab-hero-tags">
      <span class="lab-tag">Docker</span>
      <span class="lab-tag">CIS</span>
    </div>
  </div>
</div>
...
{% include-markdown "../../../labs/basic/lab06/README.md" start="</div>" %}
