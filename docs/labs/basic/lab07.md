---
title: "Лаб. 07 — SAST, SCA и поиск секретов | Курс AppSec"
...
<div class="lab-hero">
  ...
  <div class="lab-hero-content">
    <h1 class="lab-hero-title">SAST, SCA и поиск секретов</h1>
...
{% include-markdown "../../../labs/basic/lab07/README.md" start="</div>" %}
