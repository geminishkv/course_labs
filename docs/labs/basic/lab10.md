---
title: "Лаб. №10 — Итоговая оценка рисков ИБ: методология и отчёт | Курс AppSec"
...
keywords: "риски ИБ, анализ рисков, информационная безопасность, оценка угроз, AppSec, отчёт, методология, лабораторная работа, курс AppSec"
---
