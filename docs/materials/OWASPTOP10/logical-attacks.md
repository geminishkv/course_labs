...
Материал соотносится с [аналитическими кейсами ИБ](../examples/exmpl.md) и [Risk Analysis](../examples/RA.md), где рассматривается оценка бизнес-рисков. Также применим при работе над [лабораторной работой №4](../../labs/lab04.md) по анализу рисков ИБ.
