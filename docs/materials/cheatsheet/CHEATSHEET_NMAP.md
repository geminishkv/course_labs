...
description: "Шпаргалка по Nmap с пояснениями: что можно сканировать, порядок от хостов к сервисам, состояния портов, типы сканирования, определение версий, скрипты NSE, форматы вывода, чтение результата и защита файлов с результатами."
