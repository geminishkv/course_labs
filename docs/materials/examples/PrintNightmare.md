...
- `TTP` включает удаление резервных копий для предотвращения восстановления зашифрованных систем жертвами и обход средств защиты Windows для кражи учётных данных и повышения привилегий `-Vice Society` (`MITM`).
...
- Обход средств защиты Windows для кражи учётных данных и повышения прав.
