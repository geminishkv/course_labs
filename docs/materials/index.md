---
title: "Материалы курса AppSec: руководства, шпаргалки, справочники"
description: "Все материалы курса AppSec: руководства, разборы OWASP Top 10, шпаргалки по Git, Docker и CI/CD, кейсы и справочники по портам и лицензиям."
