...
- [ ] 8. Проанализируйте все уязвимости и объясните для SAST Checkov сработки статуса `Unknown`. Классифицируйте их и укажите какие не должны быть в отчетах. Внесите исправления и запустите повторное сканирование и убедитесь, что они устранены. Приложите исправленный файл и отчет без уязвимостей.
...
- [ ] 10. Убедитесь, что в финальных отчётах остались только SCA-уязвимости (зависимости), а SAST-находки устранены.
